...
const EMAIL = "tony.aloysius18@gmail.com";
...
const LINKS = [
  ...
  { label: "Itinera", icon: Smartphone, href: "#" },
];

export default function ContactSection() {
  return (
    <section id="contact" className="bg-[#0C0C0C] px-5 sm:px-8 md:px-10 py-24 sm:py-28 md:py-32">
      <FadeIn className="flex flex-col items-center text-center gap-8 sm:gap-10">
        <h2
        ...
        <p className="text-[#D7E2EA]/70 font-light max-w-md" style={{ fontSize: "clamp(0.9rem, 1.6vw, 1.1rem)" }}>
          Have an app you want to build, or an existing one that needs work? I'm currently taking on
          new projects.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-3 mt-4">
          {LINKS.map(({ label, icon: Icon, href }) => (
            <a
              key={label}
              href={href}
              className="flex items-center gap-2 rounded-full border border-[#D7E2EA]/25 text-[#D7E2EA]/80 uppercase tracking-widest text-xs sm:text-sm px-5 py-3 hover:border-[#D7E2EA]/60 hover:text-[#D7E2EA] transition-colors"
            >
              <Icon size={16} />
              {label}
            </a>
      ...
      <div className="mt-16 sm:mt-20 pt-6 border-t border-[#D7E2EA]/10 flex flex-wrap items-center justify-between gap-3 text-[#D7E2EA]/40 text-xs">
        <span>&copy; 2026 Tony Aloysius — Mobile App Developer, France</span>
        <span>Micro-entrepreneur — SIRET on request</span>
      </div>
    </section>
  );
}
